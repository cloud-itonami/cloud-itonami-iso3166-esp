...
`cloud-itonami-iso3166-esp` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Spanish-licensed counsel or a registered agent for whatever licensed
representation the law of Spain requires for public-procurement
filings.
