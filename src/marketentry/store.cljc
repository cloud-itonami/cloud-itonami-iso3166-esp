(ns marketentry.store
  "SSoT for the ESP market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems ES" :portal "PLACSP"
             ...
             :requires-nif? true :nif-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ESP" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "PLACSP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-nif? true :nif-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "PLACSP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "ESP" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "PLACSP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "ESP" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "PLACSP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-nif? true :nif-verified? false
             :drafted? false :submitted? false
             :jurisdiction "ESP" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "PLACSP"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-nif?)    (assoc :engagement/requires-nif? requires-nif?)
    (some? nif-verified?)    (assoc :engagement/nif-verified? nif-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-nif? :engagement/nif-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-nif? (boolean (:engagement/requires-nif? m))
     :nif-verified? (boolean (:engagement/nif-verified? m))
