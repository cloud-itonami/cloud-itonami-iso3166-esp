# cloud-itonami-iso3166-esp

Open ISO 3166 Blueprint for **ESP**: Spain.
...
tax registration, and local-content rules in Spain, so the operator
...
- **Not the government of Spain.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Spanish-licensed counsel
...
(ISO 3166 `ESP`). Required capabilities:
